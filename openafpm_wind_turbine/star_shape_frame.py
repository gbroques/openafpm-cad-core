...
def assemble_star_shape_frame(document, frame_path, metal_length_l, channel_section_height):
    ...
    left_middle_bracket, right_middle_bracket = make_middle_brackets(document,
                                                                     frame_path,
                                                                     metal_length_l,
                                                                     channel_section_height)
...
def make_middle_brackets(document, frame_path, metal_length_l, channel_section_height):
    # Left Middle Bracket
