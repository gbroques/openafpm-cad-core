...
def upsert_spreadsheet_document(path: Path,
...
def get_cells_by_spreadsheet_name(magnafpm_parameters: MagnafpmParameters,
                                  furling_parameters: FurlingParameters,
                                  user_parameters: UserParameters) -> Dict[str, List[List[Cell]]]:
...
def populate_spreadsheets(document: Document,
